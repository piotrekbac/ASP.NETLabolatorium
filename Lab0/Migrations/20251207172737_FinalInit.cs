        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    year_of_publishing = table.Column<int>(type: "INTEGER", nullable: false),
                    publisher_text = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "publishers",
                columns: new[] { "publisher_id", "established_year", "name" },
                values: new object[,]
                {
                    { 1, 1990, "Greg" },
                    { 2, 1991, "Helion" },
            ...
            migrationBuilder.InsertData(
                table: "books",
                columns: new[] { "book_id", "author", "isbn", "page_number", "publisher_text", "publisher_id", "title", "year_of_publishing" },
                values: new object[,]
                {
                    { 1, "Adam Mickiewicz", "1111111111", 300, null, 1, "Pan Tadeusz", 1834 },
                    { 2, "Bolesław Prus", "2222222222", 600, null, 1, "Lalka", 1890 },
                    { 3, "K.K. Martin", "3333333333", 800, null, 2, "C# Pro", 1990 }
                });
